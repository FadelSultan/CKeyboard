...
//  GateSecurity
//
//  Created by Mohammed Alqurayn on 14/03/2019.
//  Copyright © 2019 AlhasaMunicipality. All rights reserved.
//
...
class CKeyboard {
    ...
    static let defulteAlphabet = ["Q","W","E","R","T","Y","U","I","O","P","A","S","D","F","G","H","J","K","L","Z","X", "C" , "V" , "B" , "N" , "M"]
    ...
    class func create(textFileds:[UITextField] , characters:[String] )  {
        self.textFileds = textFileds
        createKeyboard(characters: characters)
    }
    
    class func create(textFileds:[UITextField] , characters:[String] , height:CGFloat? , alphabetInLine:Int? , backgroundColor:UIColor? , isHeaderHidden:Bool , headerBackroundColor:UIColor? , doneButton:String?)  {
